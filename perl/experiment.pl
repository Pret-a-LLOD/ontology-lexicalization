...
if(
	...
	if(not -s $entities_with_abstract_file){
		print " < $BASEDIR/input/inputAbstract/short-abstracts_lang=en.ttl.bz2 " . format_bytes(-s "$BASEDIR/input/inputAbstract/short-abstracts_lang=en.ttl.bz2") . "\n";
		my $zh = IO::Uncompress::Bunzip2->new(
			"$BASEDIR/input/inputAbstract/short-abstracts_lang=en.ttl.bz2",
	...
	print " < $BASEDIR/input/inputSemantic/instance-types_lang=en_specific.ttl.bz2 " . (format_bytes(-s "$BASEDIR/input/inputSemantic/instance-types_lang=en_specific.ttl.bz2")) ."\n";
	my $zh = IO::Uncompress::Bunzip2->new(
		"$BASEDIR/input/inputSemantic/instance-types_lang=en_specific.ttl.bz2",
		{ AutoClose => 1, Transparent => 1, }
	) or die "IO::Uncompress::Bunzip2 failed: $Bunzip2Error\n";
...
if(not -e $step2_finished_file){
	...
	my $labels = {};
        my $labels_file = "$BASEDIR/input/inputSemantic/labels_lang=en.ttl.bz2";
	...
	foreach my $file (
                "$BASEDIR/input/inputProperty/infobox-properties_lang=en.ttl.bz2",
                "$BASEDIR/input/inputSemantic/mappingbased-objects_lang=en.ttl.bz2",
                "$BASEDIR/input/inputSemantic/mappingbased-literals_lang=en.ttl.bz2",
                "$BASEDIR/input/inputSemantic/instance-types_lang=en_specific.ttl.bz2",
        ){
